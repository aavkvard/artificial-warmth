...
while True:
    ...
    board[random.randrange(len(board))][random.randrange(len(board[0]))] = u_height-1
    board[random.randrange(len(board))][random.randrange(len(board[0]))] = random.randrange(u_height//2)+u_height//4
    board[random.randrange(len(board))][random.randrange(len(board[0]))] = random.randrange(u_height//2)+u_height//5


    for y in range(1, u_height-1):
        for x in range(1, u_width-1):
